...
import.patient <- function (connection, project.name, data.patient) {
  ...
  features.patient <- tibble::tribble(
    ...
    "gender", "integer", "gender", NA, NA, 1, 2,
    "age", "integer", "age", NA, NA, 1, 3,
    "id", "integer", "id", NA, NA, 1, 4,
...
#    "measurement_date", "date", "measurement.date", NA, NA, 0, 2,
    ...
    "nt_pro_bnp_value_code", "character", "ntprobnp.value.code", NA, NA, 1, 6,
    "nt_pro_bnp_value_system", "character", "ntprobnp.value.system", NA, NA, 1, 7,
    "nt_pro_bnp_code", "character", "ntprobnp.code", NA, NA, 1, 8,
    "nt_pro_bnp_system", "character", "ntprobnp.system", NA, NA, 1, 9,
    "nt_pro_bnp_unit", "character", "ntprobnp.unit", NA, NA, 1, 10,
    "nt_pro_bnp_unit_label", "character", "ntprobnp.unit.label", NA, NA, 1, 11,
    "nt_pro_bnp_unit_system", "character", "ntprobnp.unit.system", NA, NA, 1, 12,
    "encounter_id", "character", "encounter.id", NA, NA, 1, 3,
    "encounter_start", "date", "encounter.start", NA, NA, 1, 13,
    "encounter_end", "date", "encounter.end", NA, NA, 1, 14,
  )
...
import.diagnosis <- function(connection, project.name, data.diagnosis) {
  ...
  features.diagnosis <- tibble::tribble(
    ...
    "condition_id", "character", "condition.id", NA, NA, 1, 1,
    "clinical_status_code", "character", "clinical.status.code", NA, NA, 1, 2,
    "clinical_status_system", "character", "clinical.status.system", NA, NA, 1, 3,
    "verification_status_code", "character", "verification.status.code", NA, NA, 1, 4,
    "verification_status_system", "character", "verification.status.system", NA, NA, 1, 5,
    "diagnosis_code", "character", "diagnosis.code", NA, NA, 1, 6,
    "diagnosis_code_system", "character", "diagnosis.code.system", NA, NA, 1, 7,
    "patient_id", "character", "patient.id", NA, NA, 1, 8,
    "encounter_id", "character", "encounter.id", NA, NA, 1, 9,
    "diagnosis_use_code", "character", "diagnosis.code", NA, NA, 1, 10,
    "diagnosis_use_system", "character", "diagnosis.system", NA, NA, 1, 11,
    "pid", "integer", "pid", NA, NA, 1, 13
  )
...
import.analysis <- function(connection, project.name, data.analysis) {
  ...
  features.analysis <- tibble::tribble(
    ~name, ~valueType, ~`label:en`, ~`Namespace::Name`, ~unit, ~repeatable, ~index,
    "id", "integer", "id", NA, NA, 0, 15,
    "encounter_id", "character", "encounter.id", NA, NA, 1, 1,
    "patient_id", "character", "patient.identifier", NA, NA, 1, 2,
    "nt_pro_bnp_value", "float", "ntprobnp.value", NA, NA, 1, 3,
    "nt_pro_bnp_unit", "character", "ntprobnp.unit", NA, NA, 1, 4,
    "nt_pro_bnp_comparator", "character", "ntprobnp.comparator", NA, NA, 1, 5,
    "gender", "integer", "gender", NA, NA, 1, 6,
    "age", "integer", "age", NA, NA, 1, 7,
    "encounter_start", "date", "encounter.start", NA, NA, 1, 8,
    "encounter_end", "date", "encounter.end", NA, NA, 1, 9,
    "IdiopathicHypotension","integer","IdiopathicHypotension", NA, NA, 1, 10,
    "AtrialFibrillation","integer","AtrialFibrillation", NA, NA, 1, 11,
    "MyocardialInfarction","integer","MyocardialInfarction", NA, NA, 1, 12,
    "HeartFailure","integer","HeartFailure", NA, NA, 1, 13,
    "Stroke","integer","Stroke", NA, NA, 1, 14,
